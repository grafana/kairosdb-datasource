System.register(["./aggregator", "./parameters/alignment_aggregator_parameter", "./parameters/enum_aggregator_parameter", "./utils"], function(exports_1) {
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
    };
    var aggregator_1, alignment_aggregator_parameter_1, enum_aggregator_parameter_1, utils_1;
    var RateAggregator;
    return {
        setters:[
